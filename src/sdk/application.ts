...
export class Application {
    ...
    async create(
        ...
        const req = new operations.CreateApplicationRequest({
            applicationApiCreateIn: applicationApiCreateIn,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
            this.sdkConfiguration.serverDefaults
        );
        const operationUrl: string = baseURL.replace(/\/$/, "") + "/api/v2/applications";
        ...
        const res: operations.CreateApplicationResponse = new operations.CreateApplicationResponse({
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.applicationApiOut = utils.objectToClass(
                        JSON.parse(decodedRes),
                        shared.ApplicationApiOut
                    );
                } else {
    ...
    async delete(
        ...
        const req = new operations.DeleteApplicationRequest({
            id: id,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
        ...
        const operationUrl: string = utils.generateURL(baseURL, "/api/v2/applications/{id}", req);
        const client: AxiosInstance = this.sdkConfiguration.defaultClient;
        let globalSecurity = this.sdkConfiguration.security;
        if (typeof globalSecurity === "function") {
            globalSecurity = await globalSecurity();
        ...
        const res: operations.DeleteApplicationResponse = new operations.DeleteApplicationResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async read(
        id: string,
        config?: AxiosRequestConfig
    ): Promise<operations.ReadApplicationResponse> {
        const req = new operations.ReadApplicationRequest({
            id: id,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
        ...
        const res: operations.ReadApplicationResponse = new operations.ReadApplicationResponse({
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
        });
    ...
    async readAll(
        ...
        size?: number,
        config?: AxiosRequestConfig
    ): Promise<operations.ReadAllApplicationsResponse> {
        const req = new operations.ReadAllApplicationsRequest({
            page: page,
            size: size,
        });
        const baseURL: string = utils.templateUrl(
        ...
        const res: operations.ReadAllApplicationsResponse =
            new operations.ReadAllApplicationsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.pageModelOutApplicationApiOut = utils.objectToClass(
                        JSON.parse(decodedRes),
                        shared.PageModelOutApplicationApiOut
                    );
                } else {
                    throw new errors.SDKError(
                        "unknown content-type received: " + contentType,
    ...
    async update(
        ...
        const req = new operations.Update1Request({
            applicationApiUpdateIn: applicationApiUpdateIn,
            id: id,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
